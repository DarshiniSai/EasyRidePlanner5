      ...
      <header className="bg-blue-600 text-white p-4 shadow-md">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button className="px-4 py-2 bg-white/20 rounded-md text-sm font-medium hover:bg-white/30 transition">Sign In</button>
            <button className="px-4 py-2 bg-white text-blue-800 rounded-md text-sm font-medium hover:bg-gray-100 transition">Sign Up</button>
          </div>
        </div>
      </header>
